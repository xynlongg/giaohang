...
return new class extends Migration
{
    ...
    public function up()
    {
        ...
        // Tạo cột 'status' mới với các giá trị enum mới
        Schema::table('orders', function (Blueprint $table) {
            $table->enum('status', ['pending', 'picked_up', 'arrived_at_post_office', 'in_transit', 'delivered', 'failed_pickup', 'failed_delivery'])
                ->default('pending');
        });
